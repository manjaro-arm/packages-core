...
sudo cp -rp /var/lib/jenkins/workspace/$2/$2/ $WORKSPACE/$_ARCH/home/manjaro/build/ #>> "$_LOGDIR"

#build package
msg "Building {$2}"
#printf "\n\n===== Building {$2} =====\n" >> "$_LOGDIR"
#sudo systemd-nspawn -D $_ARCH/ -u manjaro --chdir=/home/manjaro/ sudo chown -R manjaro build/
sudo systemd-nspawn -D $WORKSPACE/$_ARCH/ -u manjaro --chdir=/home/manjaro/ sudo chmod -R 777 build/
